package com.example.jdbcteplate.trade.controller;

import com.example.jdbcteplate.dto.*;
import com.example.jdbcteplate.trade.service.TradeService;
import com.example.jdbcteplate.trade.service.bill.BillFileAnalysis;
...
public class TradeController {
    ...
    public CommonDTO importBillFile(@RequestParam("file") MultipartFile file,@RequestParam("billType") String billType) throws IOException, ParseException {
        ...
        billFileAnalysis.importBill(f.getAbsolutePath(),billType);
        return CommonDTO.ok();
    }
